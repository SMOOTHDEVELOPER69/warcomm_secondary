        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
           ...
           >
              <div className="border-b border-primary/20 pb-4">
                 <h3 className="text-secondary font-bold uppercase text-xs tracking-[0.2em] mb-2">Relay Layer 0</h3>
                 <h4 className="text-2xl font-bold text-white">Dynamic Handshake</h4>
              ...
              <div>
                 <h3 className="text-primary font-bold uppercase text-xs tracking-[0.2em] mb-2">Store & Forward</h3>
                 <h4 className="text-2xl font-bold text-white">Packet Buffers</h4>
                 <p className="text-textMuted mt-4 text-sm leading-relaxed">
           ...
           >
              <div className="border-b border-secondary/20 pb-4">
                 ...
                 <h4 className="text-2xl font-bold text-white">Gateway Mode</h4>
                 <p className="text-textMuted mt-4 text-sm leading-relaxed">
